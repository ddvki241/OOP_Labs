...
public:
    ...
    Microwave& operator=(bool state);      // Вмикання/вимкнення
    friend int  operator<<=(Microwave& m, int watts);     // Потужність
    friend int  operator^=(Microwave& m, int seconds);    // Таймер
};
